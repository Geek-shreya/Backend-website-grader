"""
Django settings for mongodbb project.
...
MONGODB_SETTINGS = {
    'host': os.environ.get('MONGO_URI', 'mongodb://localhost:27017/emails')
}
...
WSGI_APPLICATION = 'mongodbb.wsgi.application'
